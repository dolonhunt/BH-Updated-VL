        ...
        <div className="p-4 space-y-4">
          ...
          {showFields && (
            <>
              ...
              {generated ? (
                <GeneratedBanner>✓ Personal Info Form generated. See live preview →</GeneratedBanner>
              ) : (
                <PrimaryActionButton onClick={handleGenerate}>Generate Personal Info Form</PrimaryActionButton>
              )}
            </>
          )}
        </div>
