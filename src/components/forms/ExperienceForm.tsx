        ...
        <div className="p-4 space-y-4">
          ...
          {showFields && (
            <>
              ...
              {generated ? (
                <GeneratedBanner>✓ Experience Letter generated. See live preview →</GeneratedBanner>
              ) : (
                <PrimaryActionButton onClick={handleGenerate}>Generate Experience Letter</PrimaryActionButton>
              )}
            </>
          )}
        </div>
