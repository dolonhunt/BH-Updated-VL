          ...
          {showFields && (
            <>
              ...
              <div className="space-y-3">
                <SectionHeading>Offer Letter Details</SectionHeading>
              ...
              {generated ? (
                <GeneratedBanner>✓ Offer Letter generated. See live preview →</GeneratedBanner>
              ) : (
                <PrimaryActionButton onClick={handleGenerate}>Generate Offer Letter</PrimaryActionButton>
              )}
            </>
          )}
        </div>
