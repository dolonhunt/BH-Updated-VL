...
export function getPronouns(name: string) {
  const lowercaseName = name.toLowerCase().trim()
  
  const isFemale = 
    lowercaseName.startsWith('mrs.') || 
    lowercaseName.startsWith('mrs ') || 
    lowercaseName.startsWith('ms.') || 
    lowercaseName.startsWith('ms ') || 
    lowercaseName.startsWith('miss ') ||
    lowercaseName.startsWith('miss.') ||
    lowercaseName.includes(' begum') ||
    lowercaseName.includes(' sultana') ||
    lowercaseName.startsWith('begum ') ||
    lowercaseName.startsWith('sultana ')
